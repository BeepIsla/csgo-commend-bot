...
(async () => {
	...
	for (let i = 0; i < chunks.length; i++) {
		...
		// Do commends
		console.log("red","Preloading chunks... these commends will probably fail.");
		let result = await handleChunk(chunks[i], (targetAcc instanceof Target ? targetAcc.accountid : targetAcc), serverToUse, matchID);
		console.log("red","Now commending... these commends should be successful.");
		result = await handleChunk(chunks[i], (targetAcc instanceof Target ? targetAcc.accountid : targetAcc), serverToUse, matchID);
